...
---C_LANEPLAYS : char * : in fixed lane tracks, 0=this item lane does not play, 1=this item lane plays exclusively, 2=this item lane plays and other lanes also play, -1=this item is on a non-visible, non-playing lane on a non-fixed-lane track (read-only)<br>
...
---* <strong>playcursor_drawmode</strong> : Play cursor fill mode
...
---* <strong>guideline_color</strong> : Editing guide line color
...
---@param size integer
---@return MRP_Array retval
function reaper.MRP_CreateArray(size) end

---Create window
---@param title string
---@return MRP_Window retval
