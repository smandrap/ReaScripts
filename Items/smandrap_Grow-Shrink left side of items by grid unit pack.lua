-- @author smandrap
-- @description Grow/Shrink left edge of items by grid unit
-- @version 1.0
-- @about
...
-- @metapackage
-- @provides
--   [main] smandrap_Shrink left side of items by grid unit.lua
--   [main] smandrap_Grow left side of items by grid unit.lua
